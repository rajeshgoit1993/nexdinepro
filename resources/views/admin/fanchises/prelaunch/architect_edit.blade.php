...
$fanchise_pre_launch_data=DB::table('pre_launches')->where('fanchise_id','=',$fanchise_detail->id)->first();
  ...
  <div style="padding: 0px 10px;">
    @if($request_segments=='Interior-Work-Edit') 

<h5>Interior-Work-Edit</h5>
    @elseif($request_segments=='Social-Media-Edit')
   
<h5>Social-Media-Actions</h5>
    @elseif($request_segments=='Operations-Edit')
<h5>Operations-Actions</h5>
    @elseif($request_segments=='Accounts-Edit')
...
<div class="row">
  ...
  @if($request_segments=='Interior-Work-Edit')
  @if($registered_fanchise->architect_status==1 || $registered_fanchise->architect_status==2)


   @include('admin.fanchises.prelaunch.edit.architech_edit')

@endif
<!---->
@elseif($request_segments=='Social-Media-Edit')
@if($registered_fanchise->social_media_status==1 || $registered_fanchise->social_media_status==2)

   @include('admin.fanchises.prelaunch.edit.social_edit')
...
@elseif($request_segments=='Operations-Edit')
@if($registered_fanchise->operations_status==1 || $registered_fanchise->operations_status==2)

 @include('admin.fanchises.prelaunch.edit.operations_edit')

<!---->
@endif
@elseif($request_segments=='Accounts-Edit')
@if($registered_fanchise->accounts_status==1 || $registered_fanchise->accounts_status==2)
 @include('admin.fanchises.prelaunch.edit.account_edit')


@endif
@elseif($request_segments=='Fanchise-Pre-Launch')
 @include('admin.fanchises.prelaunch.edit.franchise_edit')
