...
<div class="row">
  ...
  <div class="flex-item-left"><h5>Add Central Supply Chain</h5></div>
...
{!! Form::text("central_supply_chain_name",null,["class"=>"form-control","placeholder"=>"Enter  Crockery","required"=>""]) !!}
