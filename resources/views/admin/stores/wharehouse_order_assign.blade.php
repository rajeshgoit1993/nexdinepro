...
<div class="row">
<div class="col-lg-4">	
{{CustomHelpers::get_master_table_data('master_products','id',CustomHelpers::get_master_table_data('store_products','id',$orders_item->product_id,'product_id'),'product_name')}}
</div>
<div class="col-lg-4">	

     <div class="form-group">
     	<input type="hidden" name="" class="product_id" value="{{CustomHelpers::get_master_table_data('store_products','id',$orders_item->product_id,'product_id')}}">
...
$("#overlay").fadeIn(300);
  ...
  $.ajax({
        url:APP_URL+'/get_product_vendor_factory',
