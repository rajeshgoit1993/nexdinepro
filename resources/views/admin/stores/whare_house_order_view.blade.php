...
$factory_vendor_type=$datas->assign_type;
    ?>
         ...
         <td colspan="5">
        <?php 
    $invoice=DB::table('wharehouse_factory_invoice_by_factory_vendors')->where([['factory_vendor_id','=',(int)$store],['order_id','=',(int)$id],['order_type','=','wharehouse'],['factory_vendor_type','=',$factory_vendor_type]])->first();
