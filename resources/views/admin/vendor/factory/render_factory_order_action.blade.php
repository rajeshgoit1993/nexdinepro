...
<table class="table">
	...
	<tr>
		<td>{{$a++}}</td>
		<td>{{ CustomHelpers::get_master_table_data('stores','id',$datas->factory_id,'name') }}
		<hr style="margin:0px;padding: 0px;">
		Order ID: {{$datas->factory_order_id}}
	</td>
		<td>
...
<div class="col-lg-12">
  ...
  <?php  
    $invoice=DB::table('wharehouse_factory_invoice_by_factory_vendors')->where([['factory_vendor_id','=',$store],['order_id','=',(int)$id],['order_type','=','factory'],['factory_vendor_type','=',$factory_vendor_type]])->first();
