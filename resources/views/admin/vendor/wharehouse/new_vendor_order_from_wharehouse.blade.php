...
<div class="row">
 <section class="col-lg-12 connectedSortable">
  ...
  ?>
   @if($request_segments=='New-Vendor-Orders-From-Wharehouse') 
 <input type="hidden" name="order" id="order" value="1">
    @elseif($request_segments=='Ongoing-Vendor-Orders-From-Wharehouse')
 <input type="hidden" name="order" id="order" value="2">
     @elseif($request_segments=='Dispatched-Vendor-Orders-From-Wharehouse')
 <input type="hidden" name="order" id="order" value="3">
  @elseif($request_segments=='Delivered-Vendor-Orders-From-Wharehouse')
