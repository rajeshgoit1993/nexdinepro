...
<div class="row">
  ...
  ?>
   @if($request_segments=='Factory-Newly-Submitted-Order') 
 <input type="hidden" name="order" id="order" value="1">
    @elseif($request_segments=='Factory-Ongoing-Order')
 <input type="hidden" name="order" id="order" value="2">
     @elseif($request_segments=='Factory-Delivered-Order')
...
if ($.fn.DataTable.isDataTable('.yajra-datatable')) {
   $('.yajra-datatable').DataTable().destroy()
    ...
    var table = $('.yajra-datatable').DataTable({
        ...
        stateSave: $statesave,
        ajax: {
        url: "{{ route('get_factory_new_order') }}",
