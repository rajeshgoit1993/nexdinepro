...
<div class="tab-pane active" id="login_details">
     ...
     <input type="text" value="{{ $data->name }}" name="name" id="name" class="form-control valid" placeholder="Enter Factory Name" required />
     ...
     <div class="col-lg-6">
          <div class="form-group">
     <label>Factory Mobile No</label>
     <input type="text" name="mobile" value="{{ $data->mobile }}" id="mobile" class="form-control valid" placeholder="Enter Factory Mobile No" required />
...
<div class="tab-pane active" id="login_details">
     ...
     <div class="col-lg-6">
          <div class="form-group">
     <label>Factory Name</label>
     <input type="text" name="name" id="name" class="form-control valid" placeholder="Enter Factory Name" required />
       ...
       <div class="col-lg-6">
          <div class="form-group">
     <label>Factory Mobile No</label>
     <input type="text" name="mobile" id="mobile" class="form-control valid" placeholder="Enter Factory Mobile No" required />
