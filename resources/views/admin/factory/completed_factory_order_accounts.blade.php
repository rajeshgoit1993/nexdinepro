...
$sn=1;
    ?>
           ...
           <tr>
                <td>{{$sn++}}</td>
                <td> {{ CustomHelpers::get_master_table_data('stores','id',$order->factory_id,'name') }}   </td>
                <td> 
              {{CustomHelpers::get_master_table_data('factory_ingredients','id',$order->product_id,'product_name')}}
                 </td>
