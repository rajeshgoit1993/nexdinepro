...
$sn=1;
    ?>
           ...
           <tr>
                ...
                <td> 
                <?php 
                $order_items=DB::table('factory_order_details')->where('factory_order_id','=',$order->id)->get();
                ?>
                ...
                <td>
                 ...
                 <a href="{{url('Factory-Order-Assign/'.CustomHelpers::custom_encrypt($order->id))}}" class="btn btn-sm btn-success"><span class="fa fa-eye"></span> Take Action</a>
