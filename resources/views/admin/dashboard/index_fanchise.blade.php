...
<!--   <a href="{{url('Loi')}}"> <button  class="btn btn-default"   
  id="{{CustomHelpers::custom_encrypt($fanchise_detail->id)}}"><span class="fa fa-file-pdf"></span> Loi</button> </a>  -->
 
 <!--  <a href="#"> <button  class="btn btn-warning closees"   
  id="{{CustomHelpers::custom_encrypt($fanchise_detail->id)}}" title="PushBack"><span class="fa fa-arrow-left"></span> PushBack</button> </a> -->  

  <a href="#" ><button id="{{CustomHelpers::custom_encrypt($fanchise_detail->id)}}" class="btn btn-success accept" title="Accept"><span class="fa fa-check"></span> Accept</button></a>
