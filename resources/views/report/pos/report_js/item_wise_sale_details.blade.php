  <script>
//dsr_rsc_mtd
$(document).on("click",".item_wise_sale_details",function(){
    ...
    if(diffDays>5 && outlet==0)
    {
      alert('Date range should be less than equal to 5 days when you select all outlet')
    }
   else
   {
   ...
   form.method = "POST";
   form.action = "get_item_wise_sale_details";
