<script>
//dsr_rsc_mtd
$(document).on("click",".all_restaurants_sales_summary",function(){
...
if(diffDays>30)
{
  alert('Date range should be less than equal to 30 days')
}
else if(outlet!=0)
{
   alert('Kindly select all outlet')
}
else{
  var form = document.createElement("form");
   document.body.appendChild(form);
   form.method = "POST";
   form.action = "getall_restaurants_sales_summary";
