<script>
//detail_discount
$(document).on("click",".detail_discount",function(){
    ...
    if(diffDays>31 && outlet==0)
    {
      alert('Date range should be less than equal to 31 days when you select all outlet')
    }
   else
   {
   ...
   form.method = "POST";
   form.action = "get_detail_discount";
