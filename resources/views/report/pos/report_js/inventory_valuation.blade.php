<script>
//dsr_rsc_mtd
$(document).on("click",".inventory_valuation",function(){
...
if(diffDays>31)
{
  alert('Date range should be less than equal to 31 days')
}
else if(outlet==0)
{
   alert('Kindly select single outlet')
}
else{
  var form = document.createElement("form");
   document.body.appendChild(form);
   form.method = "POST";
   form.action = "get_inventory_valuation";
