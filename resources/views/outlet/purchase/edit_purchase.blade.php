...
<div class="row">
  ...
  <div class="flex-item-left"><h5>Edit Purchase</h5></div>
...
$gst_data.='<option value="'.$gst->gst_value.'" selected>'.$gst->gst_name.'</option>'; 
                ...
                '<td><select required  id="gst_percentage_'.$i.'"  name="gst_percentage[]" onfocus="this.select();" class="form-control" onchange="return calculateAll();">'.$gst_data.' </select>  </td>' .
