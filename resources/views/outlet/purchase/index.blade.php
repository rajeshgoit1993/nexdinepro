...
<div class="row">
  ...
  <div class="flex-item-right"><a href="{{URL::route('add_purchase')}}"><button class="btn btn-success"><span class="fa fa-plus"></span> Add Purchase</button></a></div>
</div>
...
var APP_URL=$("#APP_URL").val();
     $.ajax({
        url:APP_URL+'/delete_daily_purchase',
        data:{id:id},
        type:'get',
        // contentType: false,
        // processData: false,
