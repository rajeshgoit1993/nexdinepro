...
$outlet_details=POS_SettingHelpers::get_outlet_details((int)Sentinel::getUser()->parent_id);
                      ...
                      <!--   <img src="{{$logo_path}}"> -->
                    <h4><b>{{CustomHelpers::get_brand_name($outlet_details->brands)}}</b></h4>
                   <!--  <h5>
                        <?php echo $outlet_details->firm_name; ?>
                    </h5> -->
                    <p><?php echo $outlet_details->address; ?>
                        <br>
                     Outlet Phone: <?php echo $outlet_details->mobile; ?>

                      

                        <?= isset($sale_object->token_no) && $sale_object->token_no ? 'Token No'.": " . POS_SettingHelpers::escape_output($sale_object->token_no ): '' ?>
                        <br>
                        <?php
                                $order_type = '';
...
<?= POS_SettingHelpers::escape_output($order_type.' '.$sale_object->sale_no) ?>
               ...
               <p>Date:<?= POS_SettingHelpers::escape_output(date('d-m-Y', strtotime($sale_object->sale_date))); ?>
                    <?= POS_SettingHelpers::escape_output(date('H:i',strtotime($sale_object->order_time))) ?><!-- <br>
                    Sales Associate: <?php echo POS_SettingHelpers::escape_output($sale_object->user_name) ?><br> -->
                ...
                <table class="table table-condensed">
                    <tbody>
                        ...
                        <tr>
                            <td class="no-border border-bottom ir_wid_70"># <?php echo POS_SettingHelpers::escape_output($i++); ?>:
                                ...
                                // echo POS_SettingHelpers::escape_output($row->menu_name); ?>
                        ...
                        <tr>
                            ...
                            <td class="no-border border-bottom text-right">
                                <?php echo POS_SettingHelpers::escape_output(getAmt($modifier_price)); ?></td>
                        </tr>
                        <?php } ?>
                        <?php }
                            }
                    ...
                    <tfoot>
                        <tr>
                            <th>Total Item(s): <?php echo POS_SettingHelpers::escape_output($totalItems); ?></th>
                            <th class="ir_txt_left"></th>
                        </tr>
                        <tr>
                           <th>Sub Total</th>
                            <th class="text-right">
                                <?php echo POS_SettingHelpers::escape_output(POS_SettingHelpers::getAmt($sale_object->sub_total)); ?>
                            </th>
                        </tr>
                        <?php
                       ...
                       <th><?php echo $sale_object->charge_type; ?></th>
                        <th class="text-right">
                            <?php echo POS_SettingHelpers::escape_output((POS_SettingHelpers::getPlanTextOrP($sale_object->delivery_charge))); ?>
                        </th>
                        </tr>
                        <?php
                        endif;
                   ...
                   <!--      <tr>
                          <th>Paid Amount</th>
                            <th class="text-right">
                                <?php echo POS_SettingHelpers::escape_output(POS_SettingHelpers::getAmt($sale_object->paid_amount)); ?>
                            </th>
                        </tr> -->
                        <?php
                        endif;
                      ...
                      <!--   <tr>
                           <th>Due Amount</th>
                            <th class="text-right">
                                <?php echo POS_SettingHelpers::escape_output(POS_SettingHelpers::getAmt($sale_object->due_amount)); ?>
                            </th>
                        </tr> -->
                        <?php
                        endif;
                     ...
                     <!--    <tr>
                           <th>Given Amount</th>
                            <th class="text-right">
                                <?php echo POS_SettingHelpers::escape_output(POS_SettingHelpers::getAmt($sale_object->given_amount)); ?>
                            </th>
                        </tr> -->
                        <?php
                        endif;
                      ...
                      <!--   <tr>
                           <th>Change Amount</th>
                            <th class="text-right">
                                <?php echo POS_SettingHelpers::escape_output(POS_SettingHelpers::getAmt($sale_object->change_amount)); ?>
                            </th>
                        </tr> -->
                        <?php
                        endif;
