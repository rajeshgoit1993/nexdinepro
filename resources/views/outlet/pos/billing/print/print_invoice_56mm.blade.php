...
<tr style="margin: 0px;">
    ...
    <td style="padding:2px">Invoice No. @if($sale_object->invoice_number!='')
...
<tr style="margin: 0px;">
 ...
 @if($sale_object->payment_method_id!='')
                        <tr>
                          <th>Payment Mode</th>
                            <th class="text-right">
                               
                                <?php echo POS_SettingHelpers::escape_output(CustomHelpers::get_master_table_data('outlet_payment_methods','id',$sale_object->payment_method_id,'name')) ?>
