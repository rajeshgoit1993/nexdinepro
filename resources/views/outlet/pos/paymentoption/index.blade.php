...
<div class="row">
  ...
  <div class="flex-item-left"><h5>Payment Method</h5></div>
  <div class="flex-item-right"><a href="#"><button class="btn btn-success add_table"><span class="fa fa-plus"></span> Add Payment Method</button></a></div>
</div>
...
var APP_URL=$("#APP_URL").val();
     $.ajax({
        url:APP_URL+'/delete_payment_method',
        data:{id:id},
        type:'get',
        // contentType: false,
        // processData: false,
  ...
  $("#overlay").fadeIn(300);
   var form_data = new FormData($("#update_payment_method")[0]);
 var APP_URL=$("#APP_URL").val();
    $.ajax({
        url:APP_URL+'/update_payment_method',
        data:form_data,
        type:'post',
        contentType: false,
        processData: false,
...
var APP_URL=$("#APP_URL").val();
     $.ajax({
        url:APP_URL+'/edit_payment_method',
        data:{id:id},
        type:'get',
        // contentType: false,
        // processData: false,
  ...
  event.preventDefault();
   ...
   $('#session_modal').modal('hide');
  $("#overlay").fadeIn(300);
   var form_data = new FormData($("#store_payment_method")[0]);
 var APP_URL=$("#APP_URL").val();
    $.ajax({
        url:APP_URL+'/store_payment_method',
        data:form_data,
        type:'post',
        contentType: false,
        processData: false,
...
var APP_URL=$("#APP_URL").val();
     $.ajax({
        url:APP_URL+'/add_payment_method',
        data:{id:12},
        type:'get',
        // contentType: false,
        // processData: false,
