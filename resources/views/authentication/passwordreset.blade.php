...
<div class="login-box " style="width: 550px; margin-top: 100px !important;
  ...
  <div class="login-box-body" >
    ...
    <div class="login-logo">
      <b style="color: white">Skyland Group </b>
    </div>
    <hr>
    @if(session('error'))
  ...
  <form action="{{url('/activate/'.Request::segment(2).'/'.Request::segment(3))}}" id="frmSignIn" method="post" class="needs-validation">
    {{csrf_field()}}

        <div style="margin-bottom: 25px">
          
        <label class="font-weight-bold text-dark text-2" style="    width: 100%;
    text-align: left;">New Password</label>
...
<label class="font-weight-bold text-dark text-2" style="    width: 100%;
    text-align: left;">Confirm Password</label>
<input type="password" name="cpassword" value="" class="form-control form-control-lg" required>
        </div>
