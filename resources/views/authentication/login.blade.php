...
<div class="login-box " style="width: 550px; margin-top: 100px !important;
  ...
  <div class="login-box-body" >
    ...
    @endif
    <form action="{{ URL::to('/admin') }}" id="user_login_form" class="form-horizontal" method="POST" >
            {{csrf_field()}}

        <div style="margin-bottom: 25px" class="input-group">
          
            <input type="email" id="email" name="email" placeholder="User Id" class="form-control" value="{{old('user_id')}}" required >
        </div>
      ...
      <div class="col-md-8">
          <a href="{{URL::route('password_forget')}}" style="display: block;text-align: left;">Forget Password ?</a>
        </div>
        <div class="col-md-4" >
          <input type="button" id="user_login"  class="btn btn-primary btn-block btn-flat" value="Login" style="background: #ffba00 !important;font-size: 20px;
    color: black;
    font-weight: bold;">
        </div>
        <!-- /.col -->
