...
class ExportDsrRscMtd implements FromView, WithEvents, ShouldAutoSize
{
     ...
     if(Sentinel::getUser()->inRole('superadmin') || CustomHelpers::get_page_access_data(Sentinel::getUser()->id,'billing')==1):
         ...
         if($region==0 && $city==0 && $outlet_id==0): 
          $ids_second=User::whereIn('registration_level',[2,1])
           ...
           return view('report.pos.combine.getdsr_rsc_mtd',compact('data','outlet_id','from','to','ids_second'));
      ...
      return view('report.pos.individual.getdsr_rsc_mtd',compact('data','outlet_details','outlet_id','from','to'));
    ...
    public function registerEvents(): array
    {
      ...
      if(Sentinel::getUser()->inRole('superadmin') || CustomHelpers::get_page_access_data(Sentinel::getUser()->id,'billing')==1):
        ...
        AfterSheet::class=>function(AfterSheet $event){
            $event->sheet->getStyle('A7:AG7')->applyFromArray([
                'font'=>[
                    'bold'=>true,
                ],
                'borders' => [
            ...
            $event->sheet->getStyle('A9:AG9')->applyFromArray([
                    'borders' => [
                        'bottom' => [
                            'borderStyle' => \PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN,
                        ],
