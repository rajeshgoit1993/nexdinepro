...
class MenuMix implements FromView,WithEvents, ShouldAutoSize, WithStyles
{
    /**
     ...
     if(Sentinel::getUser()->inRole('superadmin') || CustomHelpers::get_page_access_data(Sentinel::getUser()->id,'billing')==1):
         ...
         if($region==0 && $city==0 && $outlet_id==0): 
          $ids_second=User::whereIn('registration_level',[2,1])
           ...
           return view('report.pos.combine.menu_mix',compact('data','outlet_id','from','to','ids_second'));
      ...
      return view('report.pos.combine.menu_mix',compact('data','outlet_details','outlet_id','from','to'));
