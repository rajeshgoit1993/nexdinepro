...
class BillWiseReport implements FromView, WithEvents, ShouldAutoSize, WithStyles
{
    /**
   ...
   public function view(): View
    {
     ...
     if(Sentinel::getUser()->inRole('superadmin') || CustomHelpers::get_page_access_data(Sentinel::getUser()->id,'billing')==1):
      ...
      return view('report.pos.combine.bill_wise',compact('data','outlet_id','from','to','ids_second')); 
      ...
      return view('report.pos.combine.bill_wise',compact('data','outlet_details','outlet_id','from','to'));
        elseif($region!=0 && $city!=0 && $outlet_id==0):
         $region_ids=POS_SettingHelpers::get_region_ids($region);  
            $ids_second=User::whereIn('registration_level',[2,1])
