...
class AllRestaurantsSalesSummary implements FromView,WithEvents, ShouldAutoSize, WithStyles
{
    /**
    ...
    */
    ...
    public function view(): View
    {
      ...
      $region=$this->region;
       ...
       return view('report.pos.combine.all_restaurants_sales_summary',compact('data','outlet_id','from','to','ids_second'));
       ...
       public function registerEvents(): array
    {
        return [
            AfterSheet::class=>function(AfterSheet $event){
                $event->sheet->getStyle('A:Y')->applyFromArray([
                        'fill' => [
